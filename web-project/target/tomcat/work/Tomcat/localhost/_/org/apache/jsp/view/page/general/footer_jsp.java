...
public final class footer_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_fmx_005fsetBundle_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /view/page/general/footer.jsp(3,0) name = basename type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_fmx_005fsetBundle_005f0.setBasename("locale.general.footer");
    // /view/page/general/footer.jsp(3,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_fmx_005fsetBundle_005f0.setVar("footerB");
  ...
  private boolean _jspx_meth_fmx_005fmessage_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /view/page/general/footer.jsp(6,11) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_fmx_005fmessage_005f0.setBundle((javax.servlet.jsp.jstl.fmt.LocalizationContext) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${footerB}", javax.servlet.jsp.jstl.fmt.LocalizationContext.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
    // /view/page/general/footer.jsp(6,11) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_fmx_005fmessage_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /view/page/general/footer.jsp(9,23) name = bundle type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_fmx_005fmessage_005f1.setBundle((javax.servlet.jsp.jstl.fmt.LocalizationContext) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${footerB}", javax.servlet.jsp.jstl.fmt.LocalizationContext.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
    // /view/page/general/footer.jsp(9,23) name = key type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_fmx_005fmessage_005f1.setKey("text");
